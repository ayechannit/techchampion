          ...
          <ol className="rule-list">
            <li>
              ...
              <div style={{ color: 'var(--gold)', fontWeight: 'bold', marginTop: '8px' }}>
                * ပြိုင်ပွဲ၏ တရားမျှတမှုနှင့် ယုံကြည်မှုကို ထိန်းသိမ်းရန်အတွက် Organizer (NYEIN Techno / IT Studio) ၏ Staff များ၊ Franchise / Branch ဝန်ထမ်းများ၊ ပြိုင်ပွဲစီမံခန့်ခွဲမှုတွင် ပါဝင်သူများ ပြိုင်ပွဲဝင်ခွင့် မပြုပါ။
              </div>
            </li>
